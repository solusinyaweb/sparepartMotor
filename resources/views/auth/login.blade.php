        ...
        <div class="auth-cover-sidebar-inner">
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    ...
                    <p class="fs-12 fw-medium text-muted">Terima kasih telah mengunjungi <strong>Lyora</strong> Sparepart, Disini kamu bisa menemukan sparepart yang kamu cari dengan mudah.</p>
                    <form action="index.html" class="w-100 mt-4 pt-2">
                        ...
                        <div class="mt-5">
                            <a href="/dashboard"  class="btn btn-lg btn-primary w-100">Login</a>
                        </div>
                    </form>
